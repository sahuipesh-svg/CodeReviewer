          ...
          <div className="space-y-4">
            {
              repositories.map((repo)=>(
                <div key={repo.id} 
                className="flex items-center justify-between p-4 border rounded-lg hover:bg-mutes/50 transition-colors"
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                         ...
                         variant="ghost"
                         size="sm"
                         className="ml-4 text-destructive hover:text-destructive hover:bg-destructive/10 hover:text-destructive-foreground"
